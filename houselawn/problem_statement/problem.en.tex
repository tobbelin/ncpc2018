\problemname{House Lawn}

\illustration{0.35}{mower}{\href{https://www.geograph.org.uk/photo/5790848}{Picture} by David Hawgood, CC BY-SA}%
\noindent
...
different prices!
%You clearly need to write a program to figure out which one is the best buy!
...
Then follow $m$ lines, each containing a string $n$ and $4$ integers
